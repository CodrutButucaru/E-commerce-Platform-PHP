...
if(isset($_POST["submit"])){
    ...
    $user->user_change_passwd($parola_veche, $parola_noua);}
...
<head>
    ...
    <meta name="description" content="Pagina de schimbare a parolei pentru useri.">
...
<body>
    <div id="container">
        ...
        <p><a href="home.php">Pagina Principala</a></p>
    </div>
</body>
